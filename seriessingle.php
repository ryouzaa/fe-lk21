...
<div class="page-single movie-single movie_single">
	<?php 
		$seriesById = fetchDataFromApi('/series/'.$id);

		$url = $seriesById['trailerUrl'];
		$textBtn = "Watch Trailer";
		...
		<div class="row ipad-width2">
			<div class="col-md-4 col-sm-12 col-xs-12">
				<div class="movie-img sticky-sb">
					<img src="<?=$seriesById['posterImg']?>" alt="<?=$seriesById['title']?>">
					<div class="movie-btn">	
						<div class="btn-transform transform-vertical red">
							<div><a href="#" class="item item-1 redbtn"> <i class="ion-play"></i> <?=$textBtn?></a></div>
							<div><a href="<?=$url?>" target="_blank" class="item item-2 redbtn fancybox-media hvr-grow"><i class="ion-play"></i></a></div>
						</div>
						<!--<div class="btn-transform transform-vertical">
							<div><a href="#" class="item item-1 yellowbtn"> <i class="ion-play"></i> Watch Series</a></div>
							<div><a href="<?=$seriesById['trailerUrl']?>" class="item item-2 yellowbtn fancybox-media hvr-grow"><i class="ion-play"></i></a></div>
						</div>-->
					</div>
				</div>
			</div>
			<div class="col-md-8 col-sm-12 col-xs-12">
				<div class="movie-single-ct main-content">
					<h1 class="bd-hd"><?=$seriesById['title']?></h1>
					...
					<div class="movie-rate">
						<div class="rate">
							...
							<p><span><?=$seriesById['rating']?></span> /10<br>
						...
						<div class="tabs">
						    ...
						    <div class="tab-content">
								<div id="overview" class="tab active">
						            <div class="row">
						            	<div class="col-md-8 col-sm-12 col-xs-12">
						            		<p><?=$seriesById['title']?><?=$seriesById['synopsis']?></p>
											<!--
											...
											<div class="mvcast-item">											
												<?php
													foreach ($seriesById['casts'] as $item){
												?>
												<div class="cast-it">
													<div class="cast-left">
						        ...
						        <div id="cast" class="tab">
					       	 	...
					       	 	<div id="episode" class="tab">
					       	 		<div class="row">
										<?php 
											$totalEps = $seriesById['seasons'][0]['totalEpisodes'];
											$no = 1;
											foreach (array_reverse($seriesById['seasons'][0]['linkEps']) as $key => $item){
												if ($key < $totalEps){
										?>
					       	 			<div class="mvcast-item">											
											<div class="cast-it">
